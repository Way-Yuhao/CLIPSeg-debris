...
class CLIPDensePredT(CLIPDenseBase):
    ...
    def forward(self, inp_image, conditional=None, conditional_emb=None, return_features=False, mask=None):
        ...
        if conditional is not None and conditional_emb is None:
            cond = self.get_cond_vec(conditional, bs)
        elif conditional is None and conditional_emb is not None:
            cond = conditional_emb
        elif conditional is not None and conditional_emb is not None:
            raise ValueError('cannot provide both conditional and conditional_emb')
        else:
            raise ValueError('must provide conditional or conditional_emb')
